<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="screws.aspx.cs" 
Inherits="users_screws" %>
...
<br />
<asp:Label Text="ברגים" ID="screwsLabel" runat="server" Font-Italic="true" Font-Size="20" Font-Bold="true" ForeColor="Blue" Font-Underline="true"/> <br /> <br />
<asp:Label Text="תבחר סוג הבורג -" ID="Label3" runat="server" Font-Italic="true" Font-Size="12"/> <asp:DropDownList runat="server" ID="DropDownList1" AutoPostBack="true" OnSelectedIndexChanged="DPL1changed" /> <br />
<asp:Label Text="- המכירה לפי כופסת ברגים אחת -" ID="Label4" runat="server" Font-Italic="true" Font-Size="12"/> <br /><br />
